...
local region      = "PNG"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
    ...
    /* NOTE: Some assessments will loop over `prefix'`cnt' (such as PIRLS, TIMSS),
       ...
       See the two examples below and change according to your needs */
         ...
         if `from_datalibweb'==1 {
           ...
           use "`input_dir'/2011_Madang.dta", clear
         }
		rename *, lower
         compress
         save "`temp_dir'/2011_Madang.dta", replace
    ...
    *</_level_assessment_subject_pv_>*/
    ...
    // TRAIT Vars:
    local traitvars	"age urban male idgrade total"
   ...
   *<_urban_> - Urban not available
    ...
    *</_idclass_>*/
    ...
    local samplevars "learner_weight strata1 strata2 su1 su2"
    ...
    *<_learner_weight_>
    gen learner_weight  = weight_madang
