...
local region      = "LSO"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
	...
	*<_idgrade_> 
	gen idgrade = cb5b
	replace idgrade = idgrade + 7 if cb5a== 2
	replace idgrade = idgrade + 10 if cb5a== 4
	replace idgrade = idgrade + 12 if cb5a== 3
	replace idgrade = . if idgrade>=12 & schage <=10
	label define grade 13 "tertiary" 14 "tertiary" 15 "tertiary" 16 "tertiary"
