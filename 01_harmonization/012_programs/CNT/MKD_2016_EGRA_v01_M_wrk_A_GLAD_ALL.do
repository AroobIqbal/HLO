...
local region      = "MKD"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
    ...
    *---------------------------------------------------------------------------
	...
	local list Albanian Macedonian
   ...
   *<_idschool_> 
    ...
    *</_level_assessment_subject_pv_>*/
    ...
    // TRAIT Vars:
    local traitvars	"idgrade age male total"
   ...
   * label var strata4 "Strata 4"
	...
	*<_language_test_> 
	gen language_test = "macedonian" if language== "mkd"
	replace language_test = "albanian" if language== "sqi"
	*<_language_test_>
