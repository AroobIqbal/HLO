...
local region      = "WSM"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
*/
	...
	*Generating read_comp_score_pcnt: (Reading comprehension in Croele)
	...
	foreach var of varlist read_comp1 read_comp2 read_comp3 read_comp4 read_comp5 {
		tab `var' , m
		clonevar `var'_n = `var'
		replace `var'_n = 0 if inlist(`var'_n,3,.) 
	}
	egen read_comp_score = rowtotal(read_comp1_n read_comp2_n read_comp3_n read_comp4_n read_comp5_n), missing
