...
local region      = "TLS"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
    ...
    *<_score_assessment_subject_pv_>
	gen score_egra_read = (passagecomprehension/6)*100
    ...
    *<_male_>
    gen byte male = .
	replace male = 0 if gender_female==1
	replace male = 1 if gender_female==0
    ...
    *</_idclass_>*/
    ...
    local samplevars "learner_weight su1 su2 strata2"
    ...
    *<_learner_weight_>
    gen learner_weight  = weighttotal2
