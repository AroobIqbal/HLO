...
local region      = "GUY"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
	...
	*<_idgrade_> 
	...
	replace idgrade = 11 if cb5b== 11
	replace idgrade = . if  cb5b== 99 | cb5b== 98
	replace idgrade = . if idgrade ==11 & cb5a==4
	replace idgrade = . if schage== 7 & idgrade ==9
	replace idgrade = . if schage== 5 & idgrade ==7
	replace idgrade = . if schage== 9 & idgrade ==11
