...
local region      = "TJK"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
    ...
    *---------------------------------------------------------------------------
    ...
    /* NOTE: Some assessments will loop over `prefix'`cnt' (such as PIRLS, TIMSS),
       ...
       See the two examples below and change according to your needs */
		 ...
		 rename Consent_int consent_int2
		rename *, lower
         compress
   ...
   *<_urban_> - Urban not available
	...
	*<_language_test_> 
	gen language_test = ""
	replace language_test = "russian" if language == 1
	replace language_test = "tajik" if language == 2
	*<_language_test_>
