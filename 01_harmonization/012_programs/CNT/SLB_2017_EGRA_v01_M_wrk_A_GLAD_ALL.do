...
local region      = "SLB"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
    ...
    *<_score_assessment_subject_pv_>
	gen score_egra_read = readcomp_pcnt
    ...
    *</_idclass_>*/
    ...
    local samplevars "learner_weight strata1 su1 su2 su3"
    ...
    *<_psu_>
    clonevar su1  = schoolid
    label var su1 "Primary sampling unit"
    *</_psu_>
	
	*<_strata1_>
	clonevar strata1  = province
