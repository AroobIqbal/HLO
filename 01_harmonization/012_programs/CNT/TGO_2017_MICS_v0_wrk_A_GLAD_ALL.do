...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
	...
	*<_idgrade_> 
	...
	replace idgrade = idgrade + 10 if cb5a== 3 
	replace idgrade = idgrade + 13 if cb5a== 4
	label define grade 14 "tertiary" 15 "tertiary" 16 "tertiary" 17 "tertiary" 18 "tertiary"
