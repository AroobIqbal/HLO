...
set sortseed 10051990
    ...
    *<_idlearner_>
	clonevar idlearner = masked_student_id
   ...
   *<_urban_> - Urban not available
	gen urban = .
	replace urban= 1 if type== "urban"
	replace urban =0 if type=="rural" 
...
label var escs "Predicted ESCS"
	...
	*<_language_test_> 
	gen language_test = ""
	replace language_test = "russian" if language == "R"
	replace language_test = "tajik" if language == "T"
	*<_language_test_>
