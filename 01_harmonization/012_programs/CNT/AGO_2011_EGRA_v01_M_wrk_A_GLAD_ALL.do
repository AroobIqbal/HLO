...
local region      = "AGO"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
set sortseed 10051990
    ...
    *</_level_assessment_subject_pv_>*/
    ...
    // TRAIT Vars:
    local traitvars	" male age total"
    ...
    *<_age_> 
    gen age = 2011 - birthyear
    label var age "Learner age at time of assessment"
    *</_age_>

    /* <_urban_> 
    gen urban = 1 if urbanicity_cd==2
	replace urban = 0 if urbanicity_cd==1
    ...
    *<_male_>
    gen male = .
	replace male = 0 if studentgender == "feminino"
	replace male = 1 if studentgender == "masculino"
