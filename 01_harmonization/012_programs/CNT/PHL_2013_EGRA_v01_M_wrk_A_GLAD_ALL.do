...
local region      = "PHL"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
    ...
    /* NOTE: Some assessments will loop over `prefix'`cnt' (such as PIRLS, TIMSS),
       ...
       See the two examples below and change according to your needs */
         ...
         if `from_datalibweb'==1 {
           ...
           use "`input_dir'/2013_s3.dta", clear
         }
		rename *, lower
         compress
         save "`temp_dir'/2013_s3.dta", replace
    ...
    *<_score_assessment_subject_pv_>
	gen score_egra_read_e = e_read_comp_score_pcnt*100
    label var score_egra_read_e "Percentage of correct reading comprehension questions for `assessment' e"
	gen score_egra_read_f = f_read_comp_score_pcnt*100
    label var score_egra_read_f "Percentage of correct reading comprehension questions for `assessment' f"
    *}
    *</_score_assessment_subject_pv_>
   ...
   *label var age "Learner age at time of assessment"
    ...
    *</_idclass_>*/
    ...
    local samplevars "learner_weight strata1 strata2 strata3 fpc1 fpc2 fpc3 su1 su2 su3"
	...
	*<_language_test_> 
	gen language_test = "english/filipino"
	*<_language_test_>
