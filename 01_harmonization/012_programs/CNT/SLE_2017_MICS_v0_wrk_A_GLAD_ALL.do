...
local dofile_info = "last modified by Katharina Ziegler, 11.6.2021"  /* change date*/
*
* Steps:
...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
	...
	*<official_score_assessment_math>  
	 gen score_mics_score_mics_math_official_foundational = 0
	 replace score_mics_score_mics_math_official_foundational= 1 if fl23a==1 & fl23b==1 & fl23c==1 & fl23d==1 & fl23e==1 & fl23f==1 & fl24a==1 & fl24b==1 & fl24c==1 & fl24d==1 & fl24e==1 & fl25a==1 & fl25b==1 & fl25c==1 & fl25d==1 & fl25e==1 & fl27a==1 & fl27b==1 & fl27c==1 & fl27d==1 & fl27e==1 
	 replace score_mics_score_mics_math_official_foundational=. if cb3<7 & cb3>14 
	 replace score_mics_score_mics_math_official_foundational=. if fl28!=1 
 	 *<official_score_assessment_math>
	...
	*<_idgrade_> 
	gen idgrade = cb5b
	replace idgrade = idgrade + 6 if cb5a== 2
	replace idgrade = idgrade + 9 if cb5a== 3 
	replace idgrade = idgrade + 9 if cb5a== 5
	replace idgrade = . if cb5a== 9
...
* label var idgrade grade
    ...
    *</_school_>*
    ...
    // SAMPLE Vars:		 	  /* CHANGE HERE FOR YOUR ASSESSMENT!!! */
