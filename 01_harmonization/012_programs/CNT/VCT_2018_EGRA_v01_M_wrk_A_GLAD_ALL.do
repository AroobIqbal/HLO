...
local region      = "VCT"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
set sortseed 10051990
    ...
    /* NOTE: Some assessments will loop over `prefix'`cnt' (such as PIRLS, TIMSS),
       ...
       See the two examples below and change according to your needs */
         ...
         if `from_datalibweb'==1 {
           ...
           use "`input_dir'/SVG_2018_EGRA.dta", clear
         }
		*rename (Age Library) (age2 library2)
		rename *, lower
        compress
        save "`temp_dir'/SVG_2018_EGRA.dta", replace
    ...
    *---------------------------------------------------------------------------
    ...
    // ID Vars:
    local idvars "idcntry_raw idschool year idlearner"
    ...
    *<_score_assessment_subject_pv_>
	...
	replace a2q1_n =0 if a2q1_n==. | a2q1_n==3  | a2q1_n==4 | a2q1_n==1
	replace a2q2_n=0 if a2q2_n==. | a2q2_n==3  | a2q2_n==4 | a2q2_n==1
	replace a2q3_n=0 if a2q3_n==. | a2q3_n==3  | a2q3_n==4 | a2q3_n==1
	replace a2q4_n=0 if a2q4_n==. | a2q4_n==3  | a2q4_n==4 | a2q4_n==1
	replace a2q5_n=0 if a2q5_n==. | a2q5_n==3  | a2q5_n==4 | a2q5_n==1
	egen sum = rowtotal(a2q1_n a2q2_n a2q3_n a2q4_n a2q5_n)
	gen read_comp_score_pcnt=sum/10*100
