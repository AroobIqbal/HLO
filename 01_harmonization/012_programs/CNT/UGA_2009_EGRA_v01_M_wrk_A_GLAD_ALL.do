...
local region      = "UGA"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
    ...
    *<_idgrade_>
	gen idgrade = 3 if class == 2
	replace idgrade = 2 if class == 1
    ...
    *</_idclass_>*/
    ...
    local samplevars "learner_weight su1 su3 strata1  strata3 fpc1 fpc3"
