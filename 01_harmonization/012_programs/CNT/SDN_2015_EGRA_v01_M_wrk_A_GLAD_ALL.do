...
local region      = "SDN"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
    ...
    *<_score_assessment_subject_pv_>
	gen score_egra_read = (q_5_10/5)*100
    ...
    *</_level_assessment_subject_pv_>*/
    ...
    // TRAIT Vars:
    local traitvars	" urban male total"
   ...
   *<_urban_> - Urban not available
    ...
    *<_male_>
    gen byte male = .
	replace male = 0 if q_9_6==2
	replace male = 1 if q_9_6==1
