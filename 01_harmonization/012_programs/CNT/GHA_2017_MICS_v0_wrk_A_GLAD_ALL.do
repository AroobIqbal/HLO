...
local region      = "GHA"   /* LAC, SSA, WLD or CNT such as KHM RWA */
...
local dofile_info = "last modified by Katharina Ziegler, 18.5.2021"  /* change date*/
*
* Steps:
...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
	...
	*<_idgrade_> 
	...
	replace idgrade = idgrade + 12 if cb5a== 6	
	replace idgrade = . if cb5a== 2	
	replace idgrade = . if idgrade >= 12 & schage <= 12
	...
	*<_Regionally_representative_>
	...
	Translate to STATA: 
		svyset [pweight= fsweight], strata(hh7) psu(psu) 	*/	
